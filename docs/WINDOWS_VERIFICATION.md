...
Run this checklist on the Windows PC intended to build and use the first release. It validates the source build, the self-contained portable artifact, and the normal per-user installer.

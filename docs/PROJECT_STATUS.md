...
`P2-06`: Add view archive/restore actions and browser regression coverage for the full Phase 2 journey.

## Next tasks

1. `P2-06` — Add view archive/restore actions and browser regression coverage for the full Phase 2 journey.
2. Begin Phase 3 dashboard composition.

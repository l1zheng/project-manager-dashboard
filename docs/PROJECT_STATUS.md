...
`P2-05`: Add nested `AND`/`OR` filter-group editing and view duplication/rename controls.

## Next tasks

1. `P2-05` — Add nested `AND`/`OR` filter-group editing and view duplication/rename controls.
2. Add view archive/restore actions.

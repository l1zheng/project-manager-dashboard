...
`P1-03`: Build the basic table view and inline record editing.

## Next tasks

1. `P1-03` — Build the basic table view and inline record editing.
2. `P1-04` — Add archive and restore operations for databases, fields, and records.
3. Add the first saved view definition after basic table editing is accepted.
